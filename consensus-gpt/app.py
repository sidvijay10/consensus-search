...
def lambda_handler(event, context):
    ...
    1. Create five distinct groups, or "clusters", out of the comments. 
    ...
    For each identified cluster, provide the overarching key claim that unites the comments in this cluster, a 1-2 sentence summarization that explains the main points made in the comments of this cluster, and the comment id of the comments that belong to this cluster (ordered by their relevance to the claim) outputted as a list.
    ...
    json_output = {"clusters": [], "summary": root.find('summary_and_analysis').find('answer').text}
