...
def lambda_handler(event, context):
    ...
    # Define a function to convert XML to Dict
    ...
    # Now, response dictionary has the actual comments in each cluster
    print(claims_dict)
    ...
    Generate an in-depth, comprehensive summary of the various opinions expressed in the comments. This summary should capture the full spectrum of viewpoints, highlighting key arguments, and identifying areas of consensus or disagreement. It should also provide explanations for complex or contentious points and, when necessary, illustrate these points with examples from the comments. Your summary should be more than just a restatement of the comments. Rather, it should synthesize the information and present an analytical overview of the discussion, identifying trends and contradictions.
    
    Disregard any comments that are troll-like or irrelevant, focusing instead on those that provide thoughtful, meaningful responses to the question. The final output should be structured as a single XML block which encapsulates your comprehensive summary.
    
    Here's an example of the expected response format:
    
    <llm_resp>
    <summary>comprehensive summary of the analysis</summary>
    </llm_resp>
    ...
    claims_dict["summary"] = summary_data['llm_resp'][0]['summary']
